...
These analysis are related to Brazil Convid19 pandemic data up to **2020-04-28**.

As there are too many states to have their data plotted together, were selected the 10 deadliest:['PB' 'RJ' 'PE' 'SP' 'AM' 'AL' 'PI' 'PR' 'CE' 'SE'].
