...
These analysis are related to Brazil Convid19 pandemic data up to **2020-12-04**.

As there are too many states to have their data plotted together, were selected the 10 deadliest:['PI' 'PB' 'SE' 'PE' 'SP' 'AL' 'RO' 'RJ' 'GO' 'AM'].
